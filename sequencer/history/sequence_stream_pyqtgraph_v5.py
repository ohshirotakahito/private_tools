...
class DashboardWindow(QtWidgets.QMainWindow):
    ...
    def _build_signal_card(self):
        ...
        # --- 表示時間幅スライダー(0.05s 〜 2.0s。1ms刻みの整数値で管理) ---
        self._window_slider_min = 50     # 0.05s
        self._window_slider_max = 2000   # 2.0s
        ...
        self.window_slider.setValue(int(self.window_width * 1000))
